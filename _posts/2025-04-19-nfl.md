...
We visualized team-level salary and win data to explore whether money truly buys wins in the National Football League. The scatter plot below compares each team's **regular season win percentage** (y-axis) with how much they spent **relative to the league-year average** (x-axis).

<iframe src="/assets/plots/NFL_Winning_Percentage_Salary.html" height="950" width="100%" frameborder="0"></iframe>
